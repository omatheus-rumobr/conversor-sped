...
def _processar_linha_d101(linha):
    ...
    Regras (manual 1.35):
    - REG: obrigatório, valor fixo "D101"
    ...
    alíquota e valor do crédito de PIS/Pasep, básico ou presumido, referente às operações de transporte
...
def validar_d101(linhas):
    """
    Valida uma ou mais linhas do registro D101 do SPED EFD-Contribuições.
