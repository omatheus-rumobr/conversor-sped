...
def _processar_linha_c111(linha):
    ...
    Formato:
      |C111|NUM_PROC|IND_PROC|
    
    Regras (manual 1.35):
    - REG: obrigatório, valor fixo "C111"
    ...
    para a adequada validação das contribuições sociais ou dos créditos, pelo Programa Validador e
    Assinador da EFD-Contribuições.
    
    Uma vez procedida à escrituração do Registro "C111", deve a pessoa jurídica gerar os registros
...
def validar_c111(linhas):
    """
    Valida uma ou mais linhas do registro C111 do SPED EFD-Contribuições.
