...
def _processar_linha_c381(linha):
    """
    Processa uma única linha do registro C381 e retorna um dicionário.
    
    Formato:
      |C381|CST_PIS|COD_ITEM|VL_ITEM|VL_BC_PIS|ALIQ_PIS|QUANT_BC_PIS|ALIQ_PIS_QUANT|VL_PIS|COD_CTA|
    
    Regras (manual 1.35):
    - REG: obrigatório, valor fixo "C381"
    ...
    partes = linha.split('|')
    # Remove primeiro e último se vazios (formato padrão SPED: |C381|...|)
    ...
    resultado = {
        ...
        "QUANT_BC_PIS": {
            "titulo": "Quantidade – Base de cálculo do PIS/PASEP",
            "valor": quant_bc_pis,
...
def validar_c381(linhas):
    """
    Valida uma ou mais linhas do registro C381 do SPED EFD-Contribuições.
    ...
    for linha in linhas_para_processar:
        resultado = _processar_linha_c381(linha)
