...
def _processar_linha_1700(linha, per_apu_escrit=None):
    """
    Processa uma única linha do registro 1700 e retorna um dicionário.
    
    Formato:
      |1700|IND_NAT_RET|PR_REC_RET|VL_RET_APU|VL_RET_DED|VL_RET_PER|VL_RET_DCOMP|SLD_RET|
    
    Regras (manual 1.35):
    - REG: obrigatório, valor fixo "1700"
    ...
    nos Campos 06 (VL_RET_NC) e 10 (VL_RET_CUM) dos Registros M600 deve ser feita em uma camada superior.
...
def validar_1700(linhas, per_apu_escrit=None):
    """
    Valida uma ou mais linhas do registro 1700 do SPED EFD-Contribuições.
    ...
    for linha in linhas_para_processar:
        resultado = _processar_linha_1700(linha, per_apu_escrit=per_apu_escrit)
