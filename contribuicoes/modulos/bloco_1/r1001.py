...
def _processar_linha_1001(linha):
    """
    Processa uma única linha do registro 1001 e retorna um dicionário.

    Formato: |1001|IND_MOV|

    Regras (manual 1.35):
    - REG: obrigatório, valor fixo "1001"
...
def validar_1001(linhas):
    """
    Valida uma ou mais linhas do registro 1001 do SPED EFD-Contribuições.
    ...
    for linha in linhas_para_processar:
        resultado = _processar_linha_1001(linha)
