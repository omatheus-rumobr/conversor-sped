...
def _processar_linha_0400(linha):
    ...
    Regras (manual 1.35):
    - REG: obrigatório, valor fixo "0400"
    - COD_NAT: obrigatório, até 10 caracteres
    - DESCR_NAT: obrigatório, descrição da natureza da operação/prestação
    
    Nota: Não podem ser informados dois ou mais registros com o mesmo código no campo COD_NAT.
...
def validar_0400(linhas):
    """
    Valida uma ou mais linhas do registro 0400 do SPED EFD-Contribuições.
