...
def _processar_linha_0450(linha):
    ...
    Regras (manual 1.35):
    - REG: obrigatório, valor fixo "0450"
    - COD_INF: obrigatório, até 6 caracteres
    - TXT: obrigatório, texto livre da informação complementar
    
    Nota: Não podem ser informados dois ou mais registros com o mesmo conteúdo no campo COD_INF.
...
def validar_0450(linhas):
    """
    Valida uma ou mais linhas do registro 0450 do SPED EFD-Contribuições.
