...
def _processar_linha_d590(linha):
    """
    Processa uma única linha do registro D590 e retorna um dicionário.
    
    Args:
        linha: String com uma linha do SPED no formato |D590|CST_ICMS|CFOP|ALIQ_ICMS|VL_OPR|VL_BC_ICMS|VL_ICMS|VL_BC_ICMS_UF|VL_ICMS_UF|VL_RED_BC|COD_OBS|
    ...
    partes = linha.split('|')
    # Remove primeiro e último se vazios (formato padrão SPED: |D590|...|)
...
def validar_d590_fiscal(linhas):
    """
    Valida uma ou mais linhas do registro D590 do SPED EFD Fiscal.
    
    Args:
        linhas: String com uma linha, string com múltiplas linhas separadas por \\n,
                ou lista de strings. Cada linha deve estar no formato |D590|CST_ICMS|CFOP|ALIQ_ICMS|VL_OPR|VL_BC_ICMS|VL_ICMS|VL_BC_ICMS_UF|VL_ICMS_UF|VL_RED_BC|COD_OBS|
    ...
    for linha in linhas_para_processar:
        resultado = _processar_linha_d590(linha)
