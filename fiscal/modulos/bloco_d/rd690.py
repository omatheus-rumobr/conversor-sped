...
def _processar_linha_d690(linha):
    """
    Processa uma única linha do registro D690 e retorna um dicionário.
    
    Args:
        linha: String com uma linha do SPED no formato |D690|CST_ICMS|CFOP|ALIQ_ICMS|VL_OPR|VL_BC_ICMS|VL_ICMS|VL_BC_ICMS_UF|VL_ICMS_UF|VL_RED_BC|COD_OBS|
    ...
    partes = linha.split('|')
    # Remove primeiro e último se vazios (formato padrão SPED: |D690|...|)
    ...
    # Só pode ser preenchido se CST_ICMS terminar em 20, 70 ou 90
    # Se CST_ICMS terminar em 20 ou 70, deve ser maior que zero
    if cst_icms_ultimos_dois in ["20", "70", "90"]:
...
def validar_d690(linhas):
    ...
    Args:
        linhas: String com uma linha, string com múltiplas linhas separadas por \\n,
                ou lista de strings. Cada linha deve estar no formato |D690|CST_ICMS|CFOP|ALIQ_ICMS|VL_OPR|VL_BC_ICMS|VL_ICMS|VL_BC_ICMS_UF|VL_ICMS_UF|VL_RED_BC|COD_OBS|
    ...
    for linha in linhas_para_processar:
        resultado = _processar_linha_d690(linha)
