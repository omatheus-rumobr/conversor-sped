...
def _processar_linha_d420(linha):
    """
    Processa uma única linha do registro D420 e retorna um dicionário.
    
    Args:
        linha: String com uma linha do SPED no formato |D420|COD_MUN_ORIG|VL_SERV|VL_BC_ICMS|VL_ICMS|
    ...
    partes = linha.split('|')
    # Remove primeiro e último se vazios (formato padrão SPED: |D420|...|)
...
def validar_d420(linhas):
    ...
    Args:
        linhas: String com uma linha, string com múltiplas linhas separadas por \\n,
                ou lista de strings. Cada linha deve estar no formato |D420|COD_MUN_ORIG|VL_SERV|VL_BC_ICMS|VL_ICMS|
    ...
    for linha in linhas_para_processar:
        resultado = _processar_linha_d420(linha)
