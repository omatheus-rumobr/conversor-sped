...
def _processar_linha_d360(linha):
    """
    Processa uma única linha do registro D360 e retorna um dicionário.
    
    Args:
        linha: String com uma linha do SPED no formato |D360|VL_PIS|VL_COFINS|
    ...
    partes = linha.split('|')
    # Remove primeiro e último se vazios (formato padrão SPED: |D360|...|)
    ...
    vl_pis = obter_campo(1)
    vl_cofins = obter_campo(2)
...
def validar_d360(linhas):
    ...
    Args:
        linhas: String com uma linha, string com múltiplas linhas separadas por \\n,
                ou lista de strings. Cada linha deve estar no formato |D360|VL_PIS|VL_COFINS|
    ...
    for linha in linhas_para_processar:
        resultado = _processar_linha_d360(linha)
