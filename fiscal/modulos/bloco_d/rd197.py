...
def _processar_linha_d197(linha):
    """
    Processa uma única linha do registro D197 e retorna um dicionário.
    
    Args:
        linha: String com uma linha do SPED no formato |D197|COD_AJ|DESCR_COMPL_AJ|COD_ITEM|VL_BC_ICMS|ALIQ_ICMS|VL_ICMS|VL_OUTROS|
    ...
    partes = linha.split('|')
    # Remove primeiro e último se vazios (formato padrão SPED: |D197|...|)
    ...
    # DESCR_COMPL_AJ: opcional condicional (sem validação específica de formato no manual)
    ...
    resultado = {
        ...
        "VL_BC_ICMS": {
            "titulo": "Base de cálculo do ICMS ou do ICMS ST",
        ...
        "VL_ICMS": {
            "titulo": "Valor do ICMS ou do ICMS ST",
...
def validar_d197(linhas):
    ...
    Args:
        linhas: String com uma linha, string com múltiplas linhas separadas por \\n,
                ou lista de strings. Cada linha deve estar no formato |D197|COD_AJ|DESCR_COMPL_AJ|COD_ITEM|VL_BC_ICMS|ALIQ_ICMS|VL_ICMS|VL_OUTROS|
    ...
    for linha in linhas_para_processar:
        resultado = _processar_linha_d197(linha)
