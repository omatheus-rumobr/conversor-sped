...
def _processar_linha_k291(linha):
    """
    Processa uma única linha do registro K291 e retorna um dicionário.
    ...
    - COD_ITEM: obrigatório, até 60 caracteres
      ...
      - O tipo do produto resultante (campo TIPO_ITEM do Registro 0200) deve ser igual a 03 ou 04 (validação externa)
...
def validar_k291_fiscal(linhas):
    """
    Valida uma ou mais linhas do registro K291 do SPED EFD Fiscal.
