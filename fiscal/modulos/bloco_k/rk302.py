...
def _processar_linha_k302(linha, cod_item_k301=None):
    """
    Processa uma única linha do registro K302 e retorna um dicionário.
    ...
    - COD_ITEM: obrigatório, até 60 caracteres
      ...
      - Deve ser diferente do código do produto resultante (COD_ITEM do Registro K301) quando informado
    ...
    Args:
        linha: linha SPED
        cod_item_k301: COD_ITEM do registro K301 relacionado (opcional, para validação)
    ...
    # Validação: COD_ITEM deve ser diferente do código do produto resultante (COD_ITEM do K301)
    if cod_item_k301 and cod_item == cod_item_k301:
        return None
...
def validar_k302_fiscal(linhas, cod_item_k301=None):
    """
    Valida uma ou mais linhas do registro K302 do SPED EFD Fiscal.

    Args:
        linhas: String com uma linha, string com múltiplas linhas separadas por \\n,
                ou lista de strings. Cada linha deve estar no formato:
                |K302|COD_ITEM|QTD|
        cod_item_k301: COD_ITEM do registro K301 relacionado para validação (opcional)
    ...
    for l in linhas_para_processar:
        r = _processar_linha_k302(l, cod_item_k301=cod_item_k301)
        if r is not None:
            resultados.append(r)
