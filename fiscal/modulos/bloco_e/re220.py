...
def _processar_linha_e220(linha):
    """
    Processa uma única linha do registro E220 e retorna um dicionário.

    Args:
        linha: String com uma linha do SPED no formato |E220|COD_AJ_APUR|DESCR_COMPL_AJ|VL_AJ_APUR|
    ...
    if len(cod_aj_apur) != 8:
        return None
    # Regra: terceiro caractere deve ser "1" (ajuste de ICMS ST)
    if len(cod_aj_apur) < 3 or cod_aj_apur[2] != "1":
        return None
...
def validar_e220_fiscal(linhas):
    """
    Valida uma ou mais linhas do registro E220 do SPED EFD Fiscal.

    Args:
        linhas: String com uma linha, string com múltiplas linhas separadas por \\n,
                ou lista de strings. Cada linha deve estar no formato |E220|COD_AJ_APUR|DESCR_COMPL_AJ|VL_AJ_APUR|
