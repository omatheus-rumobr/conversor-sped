...
def _processar_linha_e200(linha, dt_ini_0000=None, dt_fin_0000=None):
    """
    Processa uma única linha do registro E200 e retorna um dicionário.
    ...
    # Quando ambos informados, garante que período do E200 está contido no 0000
    ...
    return {
        ...
        "UF": {"titulo": "Sigla da unidade da federação a que se refere a apuração do ICMS ST", "valor": uf},
        "DT_INI": {
...
def validar_e200_fiscal(linhas, dt_ini_0000=None, dt_fin_0000=None):
    ...
    for l in linhas_para_processar:
        r = _processar_linha_e200(l, dt_ini_0000=dt_ini_0000, dt_fin_0000=dt_fin_0000)
        if r is not None:
            resultados.append(r)
