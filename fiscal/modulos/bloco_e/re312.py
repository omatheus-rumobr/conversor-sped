...
def _processar_linha_e312(linha):
    """
    Processa uma única linha do registro E312 e retorna um dicionário.

    Args:
        linha: String com uma linha do SPED no formato
              |E312|NUM_DA|NUM_PROC|IND_PROC|PROC|TXT_COMPL|
