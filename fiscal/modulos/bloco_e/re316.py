...
def _processar_linha_e316(linha):
    """
    Processa uma única linha do registro E316 e retorna um dicionário.

    Formato:
      |E316|COD_OR|VL_OR|DT_VCTO|COD_REC|NUM_PROC|IND_PROC|PROC|TXT_COMPL|MES_REF|
    """
    ...
    # COD_OR: obrigatório, valores válidos [000, 003, 006, 090]
    cod_or_validos = ["000", "003", "006", "090"]
    ...
    return {
        ...
        "COD_OR": {"titulo": "Código da obrigação recolhida ou a recolher, conforme a Tabela 5.4", "valor": cod_or},
        "VL_OR": {"titulo": "Valor da obrigação recolhida ou a recolher", "valor": vl_or, "valor_formatado": fmt_moeda(vl_float)},
        "DT_VCTO": {"titulo": "Data de vencimento da obrigação", "valor": dt_vcto, "valor_formatado": fmt_data(dt_obj)},
        "COD_REC": {"titulo": "Código de receita referente à obrigação, próprio da unidade da federação da origem/destino, conforme legislação estadual", "valor": cod_rec},
        ...
        "TXT_COMPL": {"titulo": "Descrição complementar das obrigações recolhidas ou a recolher", "valor": txt_compl if txt_compl else ""},
