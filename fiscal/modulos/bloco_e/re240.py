...
def _processar_linha_e240(linha):
    """
    Processa uma única linha do registro E240 e retorna um dicionário.

    Formato:
      |E240|COD_PART|COD_MOD|SER|SUB|NUM_DOC|DT_DOC|COD_ITEM|VL_AJ_ITEM|CHV_DOCe|
    """
    ...
    # COD_PART: obrigatório, até 60 caracteres (manual menciona até 15, mas registro 0150 aceita até 60)
    ...
    # VL_AJ_ITEM: obrigatório, numérico com 2 decimais, não negativo
