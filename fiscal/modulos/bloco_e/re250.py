...
def _processar_linha_e250(linha):
    """
    Processa uma única linha do registro E250 e retorna um dicionário.

    Formato:
      |E250|COD_OR|VL_OR|DT_VCTO|COD_REC|NUM_PROC|IND_PROC|PROC|TXT_COMPL|MES_REF|
    """
    ...
    # COD_OR: obrigatório, valores válidos [001, 002, 006, 999]
    cod_or_validos = ["001", "002", "006", "999"]
    ...
    return {
        ...
        "VL_OR": {"titulo": "Valor da obrigação ICMS ST a recolher", "valor": vl_or, "valor_formatado": fmt_moeda(vl_float)},
        "DT_VCTO": {"titulo": "Data de vencimento da obrigação", "valor": dt_vcto, "valor_formatado": fmt_data(dt_obj)},
        "COD_REC": {"titulo": "Código de receita referente à obrigação, próprio da unidade da federação do contribuinte substituído", "valor": cod_rec},
