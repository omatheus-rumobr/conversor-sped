...
def _processar_linha_b035(linha):
    """
    Processa uma única linha do registro B035 e retorna um dicionário.
    
    Args:
        linha: String com uma linha do SPED no formato |B035|VL_CONT_P|VL_BC_ISS_P|ALIQ_ISS|VL_ISS_P|VL_ISNT_ISS_P|COD_SERV|
    ...
    partes = linha.split('|')
    # Remove primeiro e último se vazios (formato padrão SPED: |B035|...|)
...
def validar_b035_fiscal(linhas):
    """
    Valida uma ou mais linhas do registro B035 do SPED EFD Fiscal.
    
    Args:
        linhas: String com uma linha, string com múltiplas linhas separadas por \\n,
                ou lista de strings. Cada linha deve estar no formato |B035|VL_CONT_P|VL_BC_ISS_P|ALIQ_ISS|VL_ISS_P|VL_ISNT_ISS_P|COD_SERV|
    ...
    for linha in linhas_para_processar:
        resultado = _processar_linha_b035(linha)
