...
def _processar_linha_0190(linha):
    ...
    Args:
        linha: String com uma linha do SPED no formato |0190|UNID|DESCR|
...
def validar_0190_fiscal(linhas):
    """
    Valida uma ou mais linhas do registro 0190 do SPED EFD Fiscal.
    
    Args:
        linhas: String com uma linha, string com múltiplas linhas separadas por \\n,
                ou lista de strings. Cada linha deve estar no formato |0190|UNID|DESCR|
